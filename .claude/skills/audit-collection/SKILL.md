...
- Reviewing a project's `.kiro/` tree, `~/.claude/skills/` directory, or `docs/agent/` collection
...
7. **Produce the consolidated audit report** in the format defined in `steering-audit-suite/shared/output-format.md`. Per-doc findings + cross-doc refactor proposals.
